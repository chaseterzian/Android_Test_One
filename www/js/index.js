      ...
      var xhr = new XMLHttpRequest();
        ...
        xhr.onload = function () {
          ...
          for (i = 0; i < repos.repositories.length; i++) {
            reposHTML += "<hr><p><a href='https://github.com/" + repos.repositories[i].username + "/" + repos.repositories[i].name + "'>" + repos.repositories[i].name + "</a><br>" + repos.repositories[i].description + "</p>";
          }
